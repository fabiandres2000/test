<?php 
   ...
   //dim 4
    ...
    $sql2 = "INSERT INTO `calificaciones` (`correo`, `Ansiedad`, `Hostilidad`, `Depresion`, `Ansiedad_Social`, `Impulsividad`, `Vulnerabilidad`, `Neuroticismo`, `Cordialidad`, `Gregarismo`, `Asertividad`, `Actividad`, `Busqueda_emociones`, `Emociones_positivas`, `Extraversion`, `Fantasia`, `Estetica`, `Sentimientos`, `Acciones`, `Ideas`, `Valores`, `Apertura`, `Confianza`, `Franqueza`, `Altruismo`, `A_Conciliadora`, `Modestia`, `Sensibilidad`, `Amabilidad`, `Competencia`, `Orden`, `Deber`, `Logro`, `Autodisciplina`, `Deliberacion`, `Responsabilidad`, `Negativismo`, `Aquiescencia`) VALUES ('$correo' , $Ansiedad , $Hostilidad , $Depresion , $Ansiedad_Social , $Impulsividad , $Vulnerabilidad , $Neuroticismo , $Cordialidad , $Gregarismo , $Asertividad , $Actividad , $Busqueda_emociones , $Emociones_positivas , $Extraversion , $Fantasia , $Estetica , $Sentimientos , $Acciones , $Ideas , $Valores , $Apertura , $Confianza , $Franqueza , $Altruismo , $A_Conciliadora , $Modestia , $Sensibilidad , $Amabilidad , $Competencia , $Orden , $Deber , $Logro , $Autodisciplina , $Deliberacion , $Responsabilidad , $Negativismo , $Aquiescencia)";
